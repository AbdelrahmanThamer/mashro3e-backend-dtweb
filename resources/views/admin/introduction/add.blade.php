...
<div class="right-content">
    <header class="header">
        <div class="title-control">
            ...
            <h1 class="page-title">@if($data) Edit @else Add @endif Introduction</h1>
        </div>
    ...
    <div class="body-content">
        ...
        <!-- mobile title -->
        <h1 class="page-title-sm">@if($data) Edit @else Add @endif Introduction</h1>
        <div class="card custom-border-card">
            <!--<h5 class="card-header">Add</h5>-->
            <div class="card-body">
                <form name="formSettings" id="formSettings" method="post" enctype="multipart/form-data" action="{{route("admin.introduction.save")}}">
                    @csrf 
                    <input type="hidden" name="id" value="@if($data){{$data->id}}@endif">
                    <input type="hidden" name="app_id" value="@if($data){{$data->app_id}}@endif">
                    ...
                    <div class="row">                   
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-control required" placeholder="Enter description" >@if($data){{$data->description}}@endif</textarea>
                            </div>
                        </div>  
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="mb-1">Image</label>                                
                                <input type="file" id="fileupload" class="@if($data && $data->image) @else required @endif" style="display: none"  name="file" />
