...
<div class="right-content">
    <header class="header">
        <div class="title-control">
            ...
            <h1 class="page-title">Social Share</h1>
        </div>
    ...
    <div class="body-content">
        ...
        <!-- mobile title -->
        <h1 class="page-title-sm">Social Share</h1>
...
<script type="text/javascript">
    ...
    {   
        if(app){
            window.location.href = "{{ route('admin.social_share.add')}}";       
        } else {
